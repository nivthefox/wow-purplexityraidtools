...
BigWigs or Deadly Boss Mods is required for Notes reminders after phase 1. NivUI, ElvUI, EllesmereUI, and Danders Frames integrations are optional; Blizzard roster nicknames work without them. The rest of PRT does not require an external addon.
