...
BigWigs or Deadly Boss Mods is required for Notes reminders after phase 1. NivUI and ElvUI integrations are optional; Blizzard roster nicknames work without either addon. The rest of PRT does not require an external addon.
